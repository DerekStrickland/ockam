...
mod node {
    ...
    impl NodeManager {
        ...
        pub(crate) async fn accept_invite_response(
            &self,
            ctx: &Context,
    ...
    impl NodeManagerWorker {
        pub async fn accept_invite(
            ...
            node_manager
                .accept_invite(ctx, req, route, identity_name)
                .await
        }
        ...
        pub(crate) async fn accept_invite_response(
            ...
            let node_manager = self.inner().read().await;
            node_manager.accept_invite_response(ctx, req_wrapper).await
        }
    }
}
