...
use ockam::Context;
use ockam_api::cloud::share::{CreateServiceInvite, SentInvitation};
...
impl From<ServiceCreateCommand> for CreateServiceInvite {
...
async fn run_impl(
    ...
    let send_req = async {
        ...
        rpc.request(api::share::create_service_invite(req, &CloudOpts::route()))
            .await?;
